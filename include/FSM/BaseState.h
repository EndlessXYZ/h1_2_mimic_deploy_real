...
// Fuzzy FSM name lookup: exact match first, then prefix match.
// e.g. "Mimic_Dance1_subject2" matches registered name "Mimic".
inline int fsm_id_from_name(const std::string& name)
{
    ...
    // Prefix match: find a registered name that is a prefix of |name|
