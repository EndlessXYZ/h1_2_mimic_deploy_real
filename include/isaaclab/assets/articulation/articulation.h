...
struct ArticulationData
{
    ...
    // Default joint velocities of all joints (typically zero).
    Eigen::VectorXf default_joint_vel;
    ...
    // Waist yaw angle and angular velocity (for torso IMU -> pelvis transform)
    float waist_yaw = 0.0f;
    float waist_yaw_omega = 0.0f;
